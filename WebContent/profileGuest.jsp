...
<body>
	...
	<nav class="navbar navbar-light bg-light">
		...
		<a class="nav-link active" style=" margin-top: 10px; margin-left: 350px; display: inline-block; color: grey; font-size: 18px;"href="${pageContext.request.contextPath}/Login.jsp">Login</a>
		<a class="nav-link active" style=" margin-top: 10px; margin-left: -500px; margin-right: 150px; display: inline-block; color: grey; font-size: 18px;"href="${pageContext.request.contextPath}/Register.jsp"">Register</a>
	</nav>
